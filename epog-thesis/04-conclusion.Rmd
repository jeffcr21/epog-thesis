...
This thesis has presented a framework to understand the main drivers of the green national innovative capacity. It has shown that the evolutionary approach can be fruitfully applied to environmental innovation, including through an adaptation of classical concepts like the National and Sectoral Innovation Systems. Furthermore, it has showed that the empirical frame provided by the National Innovative Capacity approach can be adapted to investigate the determinants of green innovation at a national level.

The main premise of this work has been that a combination of complementary policies in different areas is required to foster innovation in environmental technologies. To that effect, a systemic approach able to incorporate different sources of institutional constraint and their interactions is required.

Most of the literature on the economics of environmental innovation focus on the effect only of environmental policy instruments on innovation. In sight of that, this thesis adds to previous literature by including a broad series of variables in three different but related policy domains: sectoral (environmental) policies; common innovation infrastructure; and quality of governance.

Empirically, it presented an econometric model that relied on an original panel dataset for 36 OECD countries over two decades, built from various OECD and World Bank data sources. The dataset included information on eleven indicators along the three previously mentioned dimension. To measure the output of innovative activity, it used the number of patents in environmental technologies produced in each relevant country during the study period.

The results from the econometric analysis suggest that both a strong common innovation infrastructure, and targeted sectoral policies (stringent environmental policy and green R&D support) are, individually, important drivers of environmental innovation at a national level. The quality of the governance was not found to be significant for explaining the dependent variable; however, that might be due to an inadequacy of the chosen indicator.

Adding a layer of complexity, the analysis also suggest that even if investment in R&D has a very strong positive effect on environmental innovation, other institutions within the National Innovation System -in particular the relative participation of the business sector in the innovative endeavor- might actually hinder innovation in environmental technologies. This does not come a surprise; in the theoretical framework it was discussed how institutions generate regularities that create path dependencies and lock-ins that might difficult new technologies to emerge.

In terms of institutional complementarities, the interactions of variables in the model delivered mixed results, being the most significant finding that the impact of environmental policy decreases as investment in R&D increases, indicating that more remains to be done to achieve policy coherence in delivering green innovation.

These results are meant to be taken as exploratory, as more research is needed into which specific instruments -or combinations of institutional mechanisms- are more suitable to promote environmental innovation. It is also possible that different contexts call for different policy mixes. Therefore the aforementioned analysis should not be taken as a “recipe”.

A more general conclusion from this research is that innovation in general and especially the radical green innovation needed for the environmental transition does not emerge from a vacuum. Instead, it requires the active involvement of different stakeholders of the innovation process: businesses, consumers, and Governments. It also demands to carefully craft the institutional frameworks in which those actors will interact, as part of what some research calls “Transition Management” or “Strategic Niche management” (SNM). Those approaches avoid the linearity of some interventions and instead take a systemic approach, explicitly intended to create synergies between different institution aligning them with broader policy goals.
