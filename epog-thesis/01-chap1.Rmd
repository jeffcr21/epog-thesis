...
This section presents the main conceptual and theoretical elements that inform this thesis. The main aim is to offer a solid and coherent framework to understand innovation in general, first, and then adapt it to the specificities of environmental innovation. The concept of National Innovation System and National Innovative Capacity will be central to that construction.

Indeed, the neoclassical theory do not offer a satisfactory explanation for
...
that determine the outcomes of the innovation efforts. 
...
I will understand a system as constituted by a number of
...
(technological and institutional) lock-ins. According to
@nelsonBringingInstitutionsEvolutionary2002 "At any given period
...
As derived from the previous discussion, I expect all of the three variables to interact in creating the conditions for a country's capacity to produce environmental innovations. I hypothesize that sectoral policies like a more stringent environmental policy and higher investment in green R&D, as well as better quality of governance, will increase the green national innovative capacity.

The common innovation infrastructure is also considered a necessary ingredient of the capacity to innovate in green technologies. However, the effect of a very developed common innovation infrastructure can have effects that are more uncertain than in the two other cases, given the path-dependence of very strong industrial sectors that produce traditional technologies (as opposed to green technologies).